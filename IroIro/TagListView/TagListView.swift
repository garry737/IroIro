...
@objc public protocol TagListViewDelegate {
    ...
    @objc optional func tagLongPressed(_ title: String, tagView: TagView, sender: TagListView) -> Void
...
open class TagListView: UIView {
    ...
    func tagLongPressed(_ sender: TagView!) {
        //print(sender.currentTitle ?? "notitle")
        
        //sender.onLongPress?(sender)
        print("long tap tap from list")
        
        delegate?.tagLongPressed?(sender.currentTitle ?? "", tagView: sender, sender: self)
    }
